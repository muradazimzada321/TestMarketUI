...
namespace TestMarketUI
{
    public partial class NewSale : Form
    {
        ...
        void ShowCurrentClientData()
        {
            ...
            {
                MessageBox.Show("Something went wong showcurrentclientdata");
            }
        }
        ...
        private void SaveB_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"{table.Rows[0].ItemArray[1]} {table.Rows[0].ItemArray[2]}-nin borcuna {NewSaleAmTB.Text} manat əlavə olundu.\n" +
